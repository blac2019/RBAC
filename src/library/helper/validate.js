 ...
 * e.g.
 *
 * $wy.validate.isEmpty('http://192.168.0.254/1.json') => false
 * @export
 * @param {*} param
 * @returns
 */
 ...
 * e.g.
 *
 * $wy.validate.length('http://192.168.0.254/1.json', 30) => true
 * @export
 * @param {*} param
 * @param {*} length
 * @returns
 ...
 * e.g.
 *
 * $wy.validate.lengthForByte('你好1',4) => false
 * @export
 * @param {*} param
 * @param {*} length
 * @returns
 ...
 * e.g.
 *
 * $wy.validate.range('36.5', 1, 100) => false
 * @export
 * @param {*} param
 * @param {*} iMin
 * @param {*} iMax
 ...
 * e.g.
 *
 * $wy.validate.url('http://192.168.0.254/1.json') => true
 * @export
 * @param {*} param
 * @returns
 */
 ...
 * e.g.
 *
 * $wy.validate.pInterger(123) => true
 * @export
 * @param {*} param
 * @returns
 */
 ...
 * e.g.
 *
 * $wy.validate.nInterger(-123) => true
 * @export
 * @param {*} param
 * @returns
 */
 ...
 * e.g.
 *
 * $wy.validate.mobile('13011111111') => true
 * @export
 * @param {*} param
 * @returns
 */
 ...
 * e.g.
 *
 * $wy.validate.idCard('400210188801011010') => true
 * @export
 * @param {*} param
 * @returns
 */
 ...
 * e.g.
 *
 * $wy.validate.email('aa@qq.com') => true
 * @export
 * @param {*} param
 * @returns
 */
